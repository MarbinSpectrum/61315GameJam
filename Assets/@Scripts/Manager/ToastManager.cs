...
public class ToastManager
{
    ...
    // ----- Const
    private const string UI_TOAST_PATH = "UI/SubItem/UI_Toast.prefab";
    ...
    // --------------------------------------------------
    // ----- Public
    public void ShowToast(string message, float duration = DISPLAY_DURATION, EToastPositionType position = EToastPositionType.Bottom, Action onComplete = null)
    {
    ...
    private void CreateToastUI(ToastData toastData)
    {
        ...
        _currentToast = Resources.Load<GameObject>(UI_TOAST_PATH);
        if (_currentToast.TryGetComponent(out UI_Toast toastUI))
